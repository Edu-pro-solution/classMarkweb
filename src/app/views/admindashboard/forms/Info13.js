...
const navigate = useNavigate();
  ...
  return (
    <Fragment>
      ...
      <Box className="breadcrumb" style={{ display: "flex", gap: "10px", flexWrap: "wrap", alignItems: "center" }} > <button onClick={handlePrint} style={{ backgroundColor: "white", border: "1px solid black", padding: "8px 14px", borderRadius: "10px", cursor: "pointer" }} > 🖨 Print Student List </button> <button onClick={() => navigate(`/dashboard/bulk-print/S.S.1.T/first-term`)} style={{ backgroundColor: "#042954", color: "white", border: "none", padding: "8px 14px", borderRadius: "10px", cursor: "pointer", fontWeight: "bold" }}> 🖨 Bulk Print — 1st Term </button> <button onClick={() => navigate(`/dashboard/bulk-print/S.S.1.T/second-term`)} style={{ backgroundColor: "#042954", color: "white", border: "none", padding: "8px 14px", borderRadius: "10px", cursor: "pointer", fontWeight: "bold" }}> 🖨 Bulk Print — 2nd Term </button> <button onClick={() => navigate(`/dashboard/bulk-print/S.S.1.T/third-term`)} style={{ backgroundColor: "#042954", color: "white", border: "none", padding: "8px 14px", borderRadius: "10px", cursor: "pointer", fontWeight: "bold" }}> 🖨 Bulk Print — 3rd Term </button> </Box>
